...
A 股横截面 / 多因子量化研究框架。**DuckDB 单文件数据库 + 注册中心(选股/择时/仓位/策略) + 双评估路径(Pipeline 快速扫描 + BacktestEngine 完整回测) + 5 维综合评分排名**，开箱即用。
...
- 🧩 **24 个已注册策略** —— 多因子 / 筹码集中 / 超跌反弹 / 组合 / 分层，详见 [`INDEX.md`](core/strategies/impl/INDEX.md)
...
- 📡 **实盘信号** —— `data_live/<策略名>/build_<日期>.json` + HTML，策略维度目录
- ✅ **31 个单元测试**
...
详见 [`daily/2026-05-17/results/SUMMARY.md`](daily/2026-05-17/results/SUMMARY.md)
...
zequant 当前沉淀 **24 个已注册策略**，按信号类型分类:
...
> **完整排名 + 所有 24 个策略的 5 维评分见** [`core/strategies/impl/INDEX.md`](core/strategies/impl/INDEX.md)
